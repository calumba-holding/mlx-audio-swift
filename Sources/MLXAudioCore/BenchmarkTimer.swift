...
public class BenchmarkTimer {
  public class Timing {
    ...
    public var deltaTime: Double { Double(delta) / 1_000_000_000 }
    public var deltaInSec: String { String(format: "%.4f", Double(delta) / 1_000_000_000) }
  }

  public nonisolated(unsafe) static let shared = BenchmarkTimer()
  ...
  @discardableResult
  public func create(id: String, parent parentId: String? = nil) -> Timing? {
  ...
  public func printLog(id: String) {
    guard let timing = timers[id] else { return }
    timing.log()
  }
